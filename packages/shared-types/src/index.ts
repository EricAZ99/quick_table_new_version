/**
 * Point d'entrée public de @quicktable/shared-types.
 *
 * Ce paquet est vide intentionnellement au-delà de ce marqueur : les types
 * métier partagés (Order, MenuItem, enums de statut, DTO, doc 03 §3.2/§3.3)
