...
| Pentest externe + corrections                                                          | _hors granularité 1j — dépend des findings_ |
...
| Tâche                                                                                    | Estimation _(provisoire)_ |
| ---------------------------------------------------------------------------------------- | ------------------------- |
...
| Feature                    | Tâches indicatives _(provisoire, à raffiner)_                                                                                                              |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
