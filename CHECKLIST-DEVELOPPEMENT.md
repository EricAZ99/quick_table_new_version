...
| V2 *(provisoire)* | 11 | ≈ 21,5 jours-développeur |
| V3 *(provisoire)* | 12 | non chiffré — dépend des retours V2 |
...
*Rescopé au cadrage PO du 2026-07-13 : Stripe + Mobile Money retenus, mais UI/flux seuls en MVP (confirmation manuelle) ; intégration API réelle en V1 (Feature 5.2). Split bill et pourboires confirmés dès le MVP.*
...
- [ ] Pentest externe + corrections — *hors granularité 1j*

> **Critère de sortie Epic 10 = V1.5** : SLA 99,9 % tenu sur 3 mois, pentest sans faille critique ouverte.

---

## Epic 11 — Parité marché `V2` *(provisoire — contenu à confirmer avec le Product Owner)*

*Correction du 2026-07-13 : split bill et pourboires retirés de cette liste — déjà remontés au MVP (Epic 5).*
...
## Epic 12 — Différenciation `V3` *(provisoire — dépend des retours V2)*
